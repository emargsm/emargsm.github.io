...
```{r app_output, results = 'asis', eval=TRUE, echo=FALSE}
library(leaflet)
tweets <- as.data.frame(read.csv("tweets_big.csv"))
display <- tweets[sample(nrow(tweets), 10),]
...
setwd("./assets/img")
saveWidget(p2, 'leaflet2.html') # Save widget html
setwd("../..")
# Source saved file
cat('<pre><iframe src="./assets/img/leaflet2.html" width="100%" height="500px" allowtransparency="true"> </iframe></pre>')
